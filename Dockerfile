...
ENV JAVA_OPTS="-Djenkins.install.runSetupWizard=false -Dhudson.DNSMultiCast.disabled=true -Djava.awt.headless=true -Dsun.net.inetaddr.ttl=60 -Dorg.jenkinsci.plugins.gitclient.Git.timeOut=60 -Dorg.csanchez.jenkins.plugins.kubernetes.clients.cacheExpiration=60"
